...
export function buildSelectStyles<
  ...
  Group extends GroupBase<Option> = GroupBase<Option>,
>(
  styles: SelectStylesProps | undefined,
): SelectStylesConfig<Option, IsMulti, Group> | undefined {
  ...
  return {
    ...
    input: (
      { margin, paddingTop, paddingBottom, ...provided }: any,
      state: any,
    ) => ({
      ...provided,
      cursor: "text",
    ...
    ...Object.fromEntries(
      Object.entries(rest).map(([k, kStyles]) => [
        k,
