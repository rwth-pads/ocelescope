...
import {
  E2OEmissionRule_Input,
  EventEmissionRule_Input,
} from "@/src/api/generated";
import {
  EditingEmissionRule,
  getEmissionRuleDisplayName,
  isEmissionRuleEmpty,
...
export type EmissionRuleFormWrapperProps = {
  ...
  saveRule: (
    er: EditingEmissionRule | null,
    prev?: EditingEmissionRule,
  ) => void;
};
