...
import { ObjectAllocationConfig, OCPN, ProcessEmissions } from "@/src/api/generated/types.gen";
...
const useOceanStoreBase = create<OceanStore>((set) => withSetters<State, Action>(set, {
  // General
  session: undefined,
  ocel: undefined,
  apiState: undefined,
...
export const useOceanStore = createStateSelectors(createSelectors(useOceanStoreBase))
...
export const useHandlingUnits: (store: Pick<OceanStore, "ocel" | "objectTypeClasses">) => string[] | undefined = ({ ocel, objectTypeClasses }) => {
...
export const useResources: (store: Pick<OceanStore, "ocel" | "objectTypeClasses">) => string[] | undefined = ({ ocel, objectTypeClasses }) => {
...
export const useHandlingUnitsAndResources: (store: Pick<OceanStore, "ocel" | "objectTypeClasses">) => {
